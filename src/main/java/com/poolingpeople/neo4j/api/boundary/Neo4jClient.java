...
//    MultiStatementBuilder multiStatementBuilder;
    ...
    private javax.ws.rs.client.Invocation.Builder getCypherBuilder_TxCommit(){
        Client client = ClientBuilder.newClient();
        return client.target(endpoint.getCypherEndpoint_TxCommit())
                .request()
                .header("Accept", "application/json; charset=UTF-8")
                .header("Content-Type", "application/json");
    }

    private javax.ws.rs.client.Invocation.Builder getCypherBuilder_TxBegin(){
        Client client = ClientBuilder.newClient();
        return client.target(endpoint.getCypherEndpoint_TxBegin())
                .request()
                .header("Accept", "application/json; charset=UTF-8")
                .header("Content-Type", "application/json");
    }
